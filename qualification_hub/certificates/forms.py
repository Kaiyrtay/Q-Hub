...
class CertificateForm(forms.ModelForm):
    ...
    issuing_authority = forms.CharField(widget=forms.TextInput(
        attrs={'placeholder': 'Issuing Authority'}), required=False)
    certificate_number = forms.CharField(widget=forms.TextInput(
        attrs={'placeholder': 'Certificate Number'}))
    verification_url = forms.URLField(widget=forms.URLInput(
        attrs={'placeholder': 'Verification URL'}), required=False)
